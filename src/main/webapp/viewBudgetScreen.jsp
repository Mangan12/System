...
<a href="${pageContext.request.contextPath}/budgetmapping.jsp" class="btn btn-success mt-2">Create New Budget For Training +</a>
...
<!--                 </div> -->
    ...
    <script>
        ...
        function fetchDataAndDisplay() {
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/api/mapping/budget1",
                dataType: "json",
