		...
		<form id="myForm" class="text-left" onsubmit="return submitForm()">
			<div class="row">
				<div class="col-md-3">
					...
					<div class="form-group">
						<label for="resourcetype">Resource Type:</label> <select
							...
							name="resourcetype" required></select>
					</div>
					<div class="form-group">
						<label for="tagency">Agency:</label> <select
							id="tagency" name="vcontactno" class="form-control"
							name="tagency" required></select>
					</div>
					<div class="form-group">
				...
				<div class="col-md-3">
					...
					<div class="form-group">
						<label for="tendtime">Training End Time:</label> <input
							type="time" id="tendtime" class="form-control"
							name="tendtime" required>
					</div>
				...
				<div class="col-md-3">
					...
					<div class="form-group">
						<label for="estimate_budget">Budget:</label> <input
							type="text" id="estimate_budget" class="form-control"
							name="estimate_budget" placeholder="Enter Budget"
							pattern="\d*"
							oninput="this.value = this.value.replace(/\D/g, '')"
				...
				<div class="col-md-3">
					...
					<div class="form-group">
						<label for="tmode">Training Mode:</label> <select
							id="tmode" class="form-control" name="tmode"></select>
					</div>
					<div class="form-group">
