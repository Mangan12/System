...
<body>
	...
	<nav id="mainNav">
		<a id="componentmaster" href="/ComponentMaster.jsp" target="mainFramee">Component</a>
		<a href="/VendorMaster.jsp" target="mainFramee">Vendor</a>
		<a href="/HeadMaster.jsp" target="mainFramee">Head</a>
	</nav>

	<div id="content">
		<iframe src="/ComponentMaster.jsp" name="mainFramee"></iframe>
	</div>

<script>
  $(document).ready(function() {
	$('#componentmaster').addClass('active');
