...
<body>
 ...
 <div class="row">
   ...
   <div class="col-md-4">
    <a href="${pageContext.request.contextPath}/upload_academic_calender.jsp" class="btn btn-primary mt-2" style="margin-top: 20px; display: inline-block;">Upload Training Calender Data</a>
</div>
    ...
    function editTraining(training) {
        ...
        function deleteTraining(refplannerid) {
            ...
            $.ajax({
                ...
                data : {refplannerid: refplannerid},
