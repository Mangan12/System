...
<body>
	...
	<a href="${pageContext.request.contextPath}/AddNewComponentLimit.jsp" class="btn btn-success mt-2">Add Component Resource +</a>
	...
	<script>
		...
		function fetchDataAndDisplay() {
			$.ajax({
				type : "GET",
				url : "/TTSS.AP.Govt/api/getallcomponentsbystatus",
				dataType : "json",
