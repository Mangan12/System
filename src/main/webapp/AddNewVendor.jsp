			...
			<div class="form-row">
				<div class="form-column">
					<label for="name">Name:</label> <input type="text" id="name"
						required> <label for="contractperson">contract
						person:</label> <input type="text" id="contractperson"
						name="contractperson" required> <label for="contactno">Contact
						No:</label> <input type="contactno" id="contactno"
						placeholder="Enter Mobile No" required pattern="\d{10}"
						oninput="this.value = this.value.replace(/\D/g, '')"
						title="Please enter 10 numbers" maxlength="10">
				</div>
				<div class="form-column">
					<label for="vendor">vendor:</label> <input type="text" id="vendor"
						placeholder="Enter vendor"> <label for="address">Vendor
						Address:</label> <input type="text" id="address" required> <label
